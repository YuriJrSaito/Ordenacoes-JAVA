...
public class POArquivo {
    ...
    {
        double tempoInicial=0, tempoFinal=0, tempoTotalOrd=0, tempoTotalRev=0, tempoTotalRand=0;
        ...
        tempoTotalOrd = ( tempoTotalOrd / 1000 ) % 60;       
        ...
        tempoTotalRev = ( tempoTotalRev / 1000 ) % 60;
        ...
        tempoTotalRand = ( tempoTotalRand / 1000 ) % 60;
        ...
        tempoTotalRev = tempoFinal-tempoInicial;
        tempoTotalRev = ( tempoTotalRev / 1000 ) % 60;
        linha += "   || " + compRev + "|   " + "X" + "    | " + movRev + "|   " + "X" + "    |    " +Math.round(tempoTotalRev); 
        System.out.println("Reverso");
        auxRev.exibirArq();
        //Arquivo Randomico
        auxRand.copiaArquivo(arqRand);
